...
const dependencies = ['ngx-auth-firebaseui', 'ngx-material-contacts'];
...
const config = {
  libraryName: 'ngx-contacts-firebaseui',
  unscopedLibraryName: 'ngx-contacts-firebaseui',
  allSrc: 'src/**/*',
  allTs: 'src/**/!(*.spec).ts',
  ...
  // Bundle lib.
    .then(() => {
      ...
      const globals = {
        ...
        'ngx-auth-firebaseui': _.camelCase('ngx-auth-firebaseui'.replace('/', '.')),
        'ngx-material-contacts': _.camelCase('ngx-material-contacts'.replace('/', '.')),
